...
public class EditLead {
	...
	public static void main(String[] args) {
		...
		ChDriver.findElement(By.name("departmentName")).sendKeys("Qualit Assurance");
		...
		ChDriver.findElement(By.name("description")).clear();
		ChDriver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("Update using Selenium Script");
		ChDriver.findElement(By.name("submitButton")).click();
